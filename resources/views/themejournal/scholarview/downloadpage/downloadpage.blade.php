                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li class="current">
                        <div class="flex items-center">
                            ...
                            <span aria-current="page" class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400 dark:hover:text-black"><a href="/{{ $account->id }}/about/{{ $journal->path ?? 'No Data'}}/page">About ({{ $journal->title ?? 'No Data'}})  </a></span>
                        </div>
                    </li>
                </ol>
                </nav>
                ...
                <div class="prose prose-neutral max-w-none mt-4">
                    ...
                    <div class="navigation-page-content" id="navigation-page-content">
                        <p class="text-justify mt-4 tracking-wide text-sm">
                                > <a style="text-decoration: underline;"  href="/{{ $account->id }}/journal/{{ $journal->path ?? 'No Data'}}/download/{{$journal->filejr}}">Download Journal</a>
                        </p>
                    </div>
                </div>
                <div class="prose prose-neutral max-w-none mt-4">
                    ...
                    <div class="navigation-page-content" id="navigation-page-content">
                        ...
                        <p class="text-justify mt-4 tracking-wide text-sm">
                                > <a href="/{{ $account->id }}/journal/{{ $journal->path ?? 'No Data'}}/download/article/{{$item->filearticle}}" style="text-decoration: underline;">Download Article: {{$item->judul_article}}</a>
                        </p>
                        @endforeach
                    </div>
                </div>
