    ...
    <div class=" p-10 bg-cover bg-top bg-header">
        ...
        <div class="text-center bg-blue-600">
            ...
            <div class="container box-content p-10 border bg-white shadow-xl w-full ">
                ...
                <hr class="mt-3">
                <h1 class="page_title text-left font-black text-4xl mt-6">Archive Issue</h1>
                <br>
                @foreach ($issue as $item)                    
                <div class="prose prose-neutral max-w-none mt-7 mb-4">
                    <img src="/image/issue/{{ $item->image ?? 'No Data'}}" alt="" style=" height: 216px;">
                    ...
                    <h2 class="page_title text-left hover:underline text-blue-900" style="font-size: 1.28em; font-family: Lora,serif">{{ $item->judul ?? 'No Data'}}</h2>
                    </a>
