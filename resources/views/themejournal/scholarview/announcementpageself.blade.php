            ...
            <div class="flex justify-center w-full bg-cover  mt-10 ml-5">
                <div class="container box-content p-10 border bg-white shadow-xl w-full ">
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li class="current">
                                <div class="flex items-center">
                                    ...
                                    <span aria-current="page" class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400 dark:hover:text-black"><a href="/{{ $account->id }}/journal/{{ $journal->path ?? 'No Data'}}/announcement">Announcement</a></span>
                                </div>
                            </li>
                            <li class="current">
                                <div class="flex items-center">
                                    ...
                                    @foreach($announcement as $item)<span aria-current="page" class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400 dark:hover:text-black"><a href="/{{ $account->id }}/journal/{{ $journal->path ?? 'No Data'}}/announcement/{{ $item->id }}">{{ $item->title }}</a></span>@endforeach
                                </div>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <div class="prose prose-neutral max-w-none mt-4">
                        <h1 class="page_title text-left font-black text-2xl">{{ $item->title ?? 'No Data'}}</h1>
                        <div class="navigation-page-content" id="navigation-page-content">
                            <p class="text-justify mt-4 tracking-wide text-sm">
                                <i class="fa fa-calendar" aria-hidden="true"></i> {{ $item->published ?? 'No Data'}}
                            </p>
                            <p class="text-justify mt-4 tracking-wide text-sm">
