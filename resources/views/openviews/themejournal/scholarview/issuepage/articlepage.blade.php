        ...
        <div class="h-60 w-full bg-cover pt-10">
            <div class="flex justify-center ">
                <ul class="flex flex-row space-x-16 text-md">
                    <li>
                        <a href="/journal/{{ $journal->path ?? 'No Data'}}" class="text-white hover-underline-animation  underline-offset-8" aria-current="page">
                            <p>Home</p>
                        </a>
                    </li>
                    <li>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li class="current">
                                <div class="flex items-center">
                                    ...
                                    @foreach ($article as $item) <span aria-current="page" class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400 dark:hover:text-black"><a href="/journal/{{$journal->path?? 'No Data'}}/article/{{ $item->id ?? 'No Data'}}">Article: {{ $item->judul_article ?? 'No Data'}}</a></span> @endforeach
                                </div>
                            </li>
                        </ol>
                    </nav>
