            ...
            <div class="container box-content p-10 border bg-white shadow-xl w-full ">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <div class="flex items-center">
                            ...
                            <span aria-current="page" class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400 dark:hover:text-black"><a href="/journal/{{ $journal->path ?? 'No Data'}}/editors">Editorial Team</a></span>
                    </div>
                    </li>
                </ol>
                </nav>
