                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li class="current">
                                <div class="flex items-center">
                                    ...
                                    <span aria-current="page" class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400 dark:hover:text-black"><a href="/journal/{{ $journal->path ?? 'No Data'}}/announcement">Announcement</a></span>
                                </div>
                            </li>
                            <li class="current">
                                <div class="flex items-center">
                                    ...
                                    @foreach($announcement as $item)<span aria-current="page" class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400 dark:hover:text-black"><a href="/journal/{{ $journal->path ?? 'No Data'}}/announcement/{{ $item->id }}">{{ $item->title }}</a></span>@endforeach
                                </div>
                            </li>
                        </ol>
                    </nav>
