            ...
            <div class="col-md-12  ">
              <div class="comment-container">
                ...
                <div class="description text-justify">
                  <p><strong>> <a style="text-decoration: underline;"  href="/journal/{{ $journal->path ?? 'No Data'}}/download/{{$journal->filejr}}">Download Journal</a></strong></p>
                </div>
              </div>
            </div>
            <div class="col-md-12  ">
              <div class="comment-container">
                ...
                <div class="description text-justify">
                  <p><strong> > <a href="/journal/{{ $journal->path ?? 'No Data'}}/download/article/{{$item->filearticle}}" style="text-decoration: underline;">Download Article: {{$item->judul_article}}</a></strong></p>
                </div>
              </div>
              @endforeach
            </div>
