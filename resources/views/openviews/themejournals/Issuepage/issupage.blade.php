            ...
            <div class="row">
              <div class="col-sm-12  ">
                <div class="comment-container">
                  ...
                  <div class="row">
                    <div class="col-sm-2">
                      <img src="/image/issue/{{$item->image ?? 'No Data'}}" alt="" class="comment-img img-fluid">
                    </div>
                    <div class="col-sm-10">
                      <div class="comment-text">
                        <span> <a href="/journal/{{ $journal->path ?? 'No Data'}}/issue/{{ $item->id ?? 'No Data'}}" style="color: black">{{ $item->judul ?? 'none' }}</a></span>
                        <p>
                          {{ $item->published ?? 'none'}}
                        </p>
                        <p class="reply">{{ $item->volume ?? 'none'}} </p>
                      </div>
                    </div>
