        ...
        <div class=" col-lg-8 ">
          <div class="row">
            <div class="col-md-12 ">
              ...
              <div class="blog-post">
                <div> <img src="/image/issue/article/{{ $item->image ?? 'No Data'}}" alt="" class="blog-image img-fluid"></div>
                <div class="blog-description">
                  <div class="text-center">
                    <h1>{{ $item->judul_article ?? 'No Data'}}</h1>
                    <div class="post-info">
                  ...
                  <span>Abstract</span>
                  <hr>
                  <p> {{ $item->abstract ?? 'No Data' }}</p>

                  <br>
                  <span>Full Article</span>
                  <hr>
                  <p>{{ $item->isi ?? 'No Data' }}</p>
                </div>
                @endforeach
                <hr class="comment-line" style="margin-top: 50px;">
              </div>
            </div>
          </div>
        </div>
