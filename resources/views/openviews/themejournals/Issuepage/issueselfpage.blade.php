            ...
            <div class="row">
              <div class="col-md-12  ">
                ...
                <div class="comment-container">
                  <span>{{ $item->judul ?? 'No Data'}}</span>
                  <hr>
                  <div class="heading">
                    <span class="cover">
                      <img src="/image/issue/{{$item->image ?? 'No Data'}}">
                    </span>
                    <div class="description text-justify">
                      <p><strong>{{ $item->volume ?? 'No Data' }}</strong></p>
                    </div>
                    <div class="published">
                      <span class="label">
                        Published:
