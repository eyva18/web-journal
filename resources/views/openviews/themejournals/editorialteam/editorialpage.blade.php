...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/themeclassy/editorteam.css') }}" />
                    ...
                    <div class="col-sm-2">
                      ...
                      <div class="card p-3 mt-4">
                        <div class="d-flex align-items-center">
                          <div class="image">
                            <img src="/image/editors/{{ $item->image ?? 'No Data'}}" class="rounded image_editor" style="max-width: 155px; max-height: 155px">
                          </div>
                          <div class="ml-3 w-100">
                            <h4 class="mb-1 mt-0">{{ $item->name ?? 'No Data' }}</h4>
                            <span class="mt-4">{{ $item->from ?? 'No Data'}}</span>
                            <div class="p-2 mt-2 bg-primary d-flex justify-content-between rounded text-white stats">
                              <div class="d-flex flex-column">
                                <span class="articles">{{ $item->affiliation ?? 'No Data'}}</span>
                              </div>
                            </div>
                          </div>
                        </div>
