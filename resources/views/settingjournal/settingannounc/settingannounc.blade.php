                    ...
                    <div class="listPanel__header">
                        <div class="pkpHeader -isOneLine"><span class="pkpHeader__title">
                            ...
                            <div class="pkpHeader__actions">
                                <a href="/{{ $account->id }}/dashboard/{{ $journal->id }}/announcement/create" class="pkpButton" id="addbutton" style="text-decoration: none; color: #198754 !important;"> Add Announcement </a>
                            </div>
                        </div>
                    </div>
