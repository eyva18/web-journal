                ...
                <div class="card card0">
                    <div class="d-flex" id="wrapper">
                        ...
                        <div class="bg-light border-right" id="sidebar-wrapper">
                            <div class="sidebar-heading pt-5 pb-4"><strong>ADMIN</strong></div>
                            <div class="list-group list-group-flush"> <a data-toggle="tab" href="/{{$account->id}}/dashboard/empetyjournal" id="tab1" class="tabs list-group-item bg-light {{ ($title) == "adminjournal" ? 'active1' : '' }}">
                                    <div class="list-div my-2">
                                        <div class="fa fa-book"></div> &nbsp;&nbsp; JOURNAL
                                    </div>
                                </a> <a data-toggle="tab" href="/{{$account->id}}/dashboard/admin/account" id="tab2" class="tabs list-group-item bg-light {{ ($title) == "adminaccount" ? 'active1' : '' }}">
                                    <div class="list-div my-2">
                                        <div class="fa fa-users"></div> &nbsp;&nbsp; ACCOUNT
                                    </div>
                                </a> <a data-toggle="tab" href="/{{$account->id}}/dashboard/admin/request" id="tab3" class="tabs list-group-item bg-light {{ ($title) == "adminrequest" ? 'active1' : '' }}">
                                    <div class="list-div my-2">
                                        <div class="fa fa-archive"></div> &nbsp;&nbsp;&nbsp; REQUEST
                                    </div>
                                </a>  </div>
                        </div> <!-- Page Content -->
                        <div id="page-content-wrapper">
                            ...
                            <div class="row justify-content-center">
                                <div class="text-center" id="test">Setting</div>
                            </div>
                                @yield('content')
                            </div>
                        </div>
