                ...
                <div class="listPanel">
                    <div class="listPanel__header">
                        <div class="pkpHeader -isOneLine"><span class="pkpHeader__title">
                                <h2 style="font-size:30px"><strong>Account</strong></h2>
                                <!---->
                            </span>
                            <div class="pkpHeader__actions">
                                <a href="/{{ $account->id ?? 'none'}}/dashboard/admin/account/createnew" class="pkpButton" id="addbutton" style="text-decoration: none; color: #198754 !important;"> Add Account </a>
                            </div>
                        </div>
                    </div>
                                ...
                                <li class="listPanel__item">
                                    <div class="listPanel__itemSummary">
                                        <div class="listPanel__itemIdentity">
                                            <div class="listPanel__itemTitle"> {{$item->username ?? 'none'}} </div>
                                            <!---->
                                        </div>
                                        <div class="listPanel__itemActions">
                                            <a href="/{{ $account->id ?? 'none'}}/dashboard/admin/account/edit/{{$item->id}}" class="pkpButton" style="text-decoration: none; color: #198754 !important;"> Edit </a> <form action="/{{ $account->id ?? 'none'}}/dashboard/admin/account/delete/{{$item->id}}" method="post"> @csrf<button class="pkpButton pkpButton--isWarnable" onclick="return confirm('Are you sure you want to Remove?');" style="text-decoration: none; color: red !important;"> Delete </button></form>
                                        </div>
                                    </div>
                                    <!---->
                                </li>
