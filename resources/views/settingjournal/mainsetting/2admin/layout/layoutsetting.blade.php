                        ...
                        <div class="bg-light border-right" id="sidebar-wrapper">
                            ...
                            <div class="list-group list-group-flush"> <a data-toggle="tab" href="/{{$account->id}}/dashboard/empetyjournal" id="tab1" class="tabs list-group-item bg-light {{ ($title) == "journal1" ? 'active1' : '' }}">
                                    <div class="list-div my-2">
                                        <div class="fa fa-chevron-right"></div> &nbsp;&nbsp; <b>{{$journal1is}}</b>
                                    </div>
                                </a> <a data-toggle="tab" style="border-bottom: 3px;" href="/{{$account->id}}/dashboard/setting/category2" id="tab2" class="tabs list-group-item bg-light {{ ($title) == "journal2" ? 'active1' : '' }}">
                                    <div class="list-div my-2">
                                        <div class="fa fa-chevron-right"></div> &nbsp;&nbsp; <b>{{$journal2is}}</b>
                                    </div>
                                </a>

                                <div style="margin-top: 10px;">
                                    <a data-toggle="tab" href="/{{ $account->id }}/dashboard/edit/{{$journal->id}}/category/{{$journalcategory}}" id="tab2" class="tabs list-group-item bg-light {{ ($title) == "journalset" ? 'active1' : '' }}">
                                        <div class="list-div my-2">
                                            <div class="fa fa-book"></div> &nbsp;&nbsp; Journal Setting
                                        </div>
                                    </a>
                                    <a data-toggle="tab" href="/{{ $account->id }}/dashboard/edit/{{$journal->id}}/category/{{$journalcategory}}/aboutjournal" id="tab2" class="tabs list-group-item bg-light {{ ($title) == "aboutset" ? 'active1' : '' }}">
                                        <div class="list-div my-2">
                                            <div class="fa fa-info-circle"></div> &nbsp;&nbsp; About Journal
                                        </div>
                                    </a> <a data-toggle="tab" href="/{{ $account->id }}/dashboard/edit/{{$journal->id}}/category/{{$journalcategory}}/issue" id="tab3" class="tabs list-group-item bg-light {{ ($title) == "issueset" ? 'active1' : '' }}">
                                        <div class="list-div my-2">
                                            <div class="fa fa-archive"></div> &nbsp;&nbsp;&nbsp; Issue
                                        </div>
                                    </a> <a data-toggle="tab" href="/{{ $account->id }}/dashboard/edit/{{$journal->id}}/category/{{$journalcategory}}/article" id="tab4" class="tabs list-group-item bg-light {{ ($title) == "articleset" ? 'active1' : '' }}">
                                        <div class="list-div my-2">
                                            <div class="fa fa-file"></div> &nbsp;&nbsp;&nbsp; Article
                                        </div>
                                    </a>
                                    <a data-toggle="tab" href="/{{ $account->id }}/dashboard/edit/{{$journal->id}}/category/{{$journalcategory}}/announcement" id="tab5" class="tabs list-group-item bg-light {{ ($title) == "announcset" ? 'active1' : '' }}">
                                        <div class="list-div my-2">
                                            <div class="fa fa-bullhorn"></div> &nbsp;&nbsp;&nbsp; Announcement
                                        </div>
                                    </a>
                                    <a data-toggle="tab" href="/{{ $account->id }}/dashboard/edit/{{$journal->id}}/category/{{$journalcategory}}/editorialteam" id="tab6" class="tabs list-group-item bg-light {{ ($title) == "editorset" ? 'active1' : '' }}">
                                        <div class="list-div my-2">
